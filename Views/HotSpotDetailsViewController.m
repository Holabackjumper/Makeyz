//
//  HotSpotDetailsViewController.m
//  Makemoves
//
...
@interface HotSpotDetailsViewController ()

@end

@implementation HotSpotDetailsViewController
...

{
    ...
    self.nameLabel.text = hotspot.name;
}
...
-(void)retriveFromParse
{
    ...
    PFQuery *query = [PFQuery queryWithClassName:hotspot.selectedUsername];
...
- (IBAction)sendButton:(id)sender {
    ...
    NSString *alertmessage = [NSString stringWithFormat:@"%@ %@%@", @"Send contact information to:", hotspot.name, @"?"];
...
- (void)alertView:(UIAlertView *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    else
    {
        ...
        PFObject *send =  [PFObject objectWithClassName:hotspot.selectedUsername];
        ...
        [send saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
            ...
            if (!error) {
                ...
                [push setChannel:hotspot.selectedUsername];
                [push setData:data];
